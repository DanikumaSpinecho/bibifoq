...
class MainActivity : ComponentActivity() {
    ...
    private fun extractSharedUrl(intent: Intent?): String? {
        ...
        return UrlNormalizer.extractFirstUrl(text) ?: text.takeIf { UrlNormalizer.normalize(it) != null }
    }
    ...
    Scaffold(
        ...
        when (tab) {
            ...
            Tab.DOWNLOADS -> DownloadsScreen(
                ...
                onRemove = { id -> scope.launch { services.downloads.remove(id) } },
            ...
            Tab.SETTINGS -> SettingsScreen(
                ...
                onUpdateEngine = {
                    scope.launch {
                        snackbar.showSnackbar(
                            runCatching { services.ytDlpEngine.update() }
                ...
                onClearCache = {
                    scope.launch {
                        ...
                        snackbar.showSnackbar("Metadata cache cleared")
                    }
                },
                modifier = Modifier.padding(padding),
            )
